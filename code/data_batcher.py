...
from load_pretrained import PAD_ID, UNK_ID
...
def get_batch_generator(word2id, context_path, qn_path, ans_path, batch_size, context_len, question_len, discard_long):
    ...
    while True:
        ...
        qn_ids = np.array(list(qn_ids)) # shape (question_len, batch_size)
        ...
        context_ids = np.array(list(context_ids)) # shape (context_len, batch_size)
